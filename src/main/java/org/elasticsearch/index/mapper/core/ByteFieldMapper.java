...
public class ByteFieldMapper extends NumberFieldMapper<Byte> {
    ...
    public static class Builder extends NumberFieldMapper.Builder<Builder, ByteFieldMapper> {
        ...
        public ByteFieldMapper build(BuilderContext context) {
            ...
            ByteFieldMapper fieldMapper = new ByteFieldMapper(buildNames(context),
                    ...
                    postings, docValues, similarity, fieldDataSettings);
    ...
    protected ByteFieldMapper(Names names, int precisionStep, float boost, FieldType fieldType,
                              Byte nullValue, Explicit<Boolean> ignoreMalformed, PostingsFormatProvider provider, DocValuesFormatProvider docValuesProvider, SimilarityProvider similarity, @Nullable Settings fieldDataSettings) {
        super(names, precisionStep, boost, fieldType,
                ...
                new NamedAnalyzer("_byte/max", new NumericIntegerAnalyzer(Integer.MAX_VALUE)), provider, docValuesProvider, similarity, fieldDataSettings);
        this.nullValue = nullValue;
