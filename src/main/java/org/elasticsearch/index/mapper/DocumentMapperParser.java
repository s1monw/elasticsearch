...
public class DocumentMapperParser extends AbstractIndexComponent {
    ...
    public DocumentMapperParser(Index index, AnalysisService analysisService, PostingsFormatService postingsFormatService, DocValuesFormatService docValuesFormatService,
                                SimilarityLookupService similarityLookupService) {
        this(index, ImmutableSettings.Builder.EMPTY_SETTINGS, analysisService, postingsFormatService, docValuesFormatService, similarityLookupService);
    }
