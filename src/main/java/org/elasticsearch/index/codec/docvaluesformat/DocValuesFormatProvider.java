 ...
 * <p>
 * Each {@link DocValuesFormatProvider} must provide a unique name for its
 ...
 * postings format in {@link DocValuesFormatService#get(String)} and should be
 * identical to the values used in the field mappings.
 * </p>
 * <p>
 * {@link DocValuesFormatProvider} instances are initialized with a
 * {@link Settings} subset below the
 * {@value DocValuesFormatProvider#DOCVALUES_FORMAT_SETTINGS_PREFIX} prefix and
 ...
 * <tt>index.codec.docvalues_format.elastic_fantastic</tt> given that the
 * postings format is exposed via
 * <tt>index.codec.docvalues_format.elastic_fantastic.type : "ElasticFantastic"</tt>.
 * </p>
 *
 * @see CodecModule
 */
public interface DocValuesFormatProvider {
    public static final String DOCVALUES_FORMAT_SETTINGS_PREFIX = "index.codec.docvalues_format";
    ...
    public static class Helper {
         ...
         * All settings with the {@value DocValuesFormatProvider#DOCVALUES_FORMAT_SETTINGS_PREFIX} prefix
        ...
        public static DocValuesFormatProvider lookup(@IndexSettings Settings indexSettings, String name, Map<String, Factory> docValuesFormatFactories) throws ElasticSearchIllegalArgumentException {
            ...
            Settings settings = indexSettings.getGroups(DOCVALUES_FORMAT_SETTINGS_PREFIX).get(name);
            if (settings == null) {
    ...
    /**
     * A simple factory used to create {@link DocValuesFormatProvider} used by
     * delegating providers. Those providers wrap other
     * DocValues formats to enrich their capabilities.
     */
