...
/**
 */
public final class PreBuiltDocValuesFormatProvider implements DocValuesFormatProvider {
    ...
    public PreBuiltDocValuesFormatProvider(String name, DocValuesFormat docValuesFormat) {
        this.name = name;
