 ...
 * 
 * <ul>
 * <li>{@value #KEEP_WORDS_KEY} the set of words / tokens to keep. This can be
 * suffixed with <tt>_path</tt> to reference a file.</li>
 * 
...
public class KeepWordFilterFactory extends AbstractTokenFilterFactory {
    ...
    @Inject
    public KeepWordFilterFactory(Index index, @IndexSettings Settings indexSettings, Environment env, IndicesAnalysisService indicesAnalysisService, Map<String, TokenizerFactoryFactory> tokenizerFactories,
