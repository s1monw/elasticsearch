...
public class SearchPhaseController extends AbstractComponent {
    ...
    public AggregatedDfs aggregateDfs(Iterable<DfsSearchResult> results) {
        Map<Term, TermStatistics> termStatistics = Maps.newNoNullKeysMap();
        Map<String, CollectionStatistics> fieldStatistics = Maps.newNoNullKeysMap();
        long aggMaxDoc = 0;
    ...
    public Map<SearchShardTarget, ExtTIntArrayList> docIdsToLoad(ShardDoc[] shardDocs) {
        Map<SearchShardTarget, ExtTIntArrayList> result = Maps.newMap();
