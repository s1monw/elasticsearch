...
public class PipelineStoreTests extends ESTestCase {
    ...
    public void testValidate() throws Exception {
        ...
        DiscoveryNode node1 = new DiscoveryNode("_node_id1", MockTcpTransport.buildFakeLocalAddress(0),
                emptyMap(), emptySet(), Version.CURRENT);
        DiscoveryNode node2 = new DiscoveryNode("_node_id2", MockTcpTransport.buildFakeLocalAddress(1),
                emptyMap(), emptySet(), Version.CURRENT);
    ...
    public void testValidateNoIngestInfo() throws Exception {
        ...
        DiscoveryNode discoveryNode = new DiscoveryNode("_node_id", MockTcpTransport.buildFakeLocalAddress(0),
                emptyMap(), emptySet(), Version.CURRENT);
