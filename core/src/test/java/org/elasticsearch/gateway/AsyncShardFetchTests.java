...
public class AsyncShardFetchTests extends ESTestCase {
    private final DiscoveryNode node1 = new DiscoveryNode("node1", MockTcpTransport.buildFakeLocalAddress(), Collections.emptyMap(),
    ...
    private final DiscoveryNode node2 = new DiscoveryNode("node2", MockTcpTransport.buildFakeLocalAddress(), Collections.emptyMap(),
            Collections.singleton(DiscoveryNode.Role.DATA), Version.CURRENT);
