...
public class DiscoveryNodeFiltersTests extends ESTestCase {
    ...
    public void testNameMatch() {
        ...
        DiscoveryNode node = new DiscoveryNode("name1", "id1", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(),
            Version.CURRENT);
        assertThat(filters.match(node), equalTo(true));

        node = new DiscoveryNode("name2", "id2", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT);
    ...
    public void testIdOrNameMatch() {
        ...
        DiscoveryNode node = new DiscoveryNode("name1", "id1", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), version);
        assertThat(filters.match(node), equalTo(true));

        node = new DiscoveryNode("name2", "id2", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), version);
        assertThat(filters.match(node), equalTo(true));

        node = new DiscoveryNode("name3", "id3", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), version);
        assertThat(filters.match(node), equalTo(false));
    }
    ...
    public void testTagAndGroupMatch() {
        ...
        DiscoveryNode node = new DiscoveryNode("name1", "id1", MockTcpTransport.buildFakeLocalAddress(),
        ...
        node = new DiscoveryNode("name2", "id2", MockTcpTransport.buildFakeLocalAddress(),
                attributes, emptySet(), Version.CURRENT);
        assertThat(filters.match(node), equalTo(true));
        ...
        attributes.put("name", "X");
        node = new DiscoveryNode("name3", "id3", MockTcpTransport.buildFakeLocalAddress(),
                attributes, emptySet(), Version.CURRENT);
        assertThat(filters.match(node), equalTo(false));

        node = new DiscoveryNode("name4", "id4", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT);
        assertThat(filters.match(node), equalTo(false));
    }
