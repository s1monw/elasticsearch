...
public class DiskThresholdDeciderTests extends ESAllocationTestCase {
    ...
    public void testCanRemainWithShardRelocatingAway() {
        ...
        DiscoveryNode discoveryNode1 = new DiscoveryNode("node1", MockTcpTransport.buildFakeLocalAddress(), emptyMap(),
                MASTER_DATA_ROLES, Version.CURRENT);
        DiscoveryNode discoveryNode2 = new DiscoveryNode("node2", MockTcpTransport.buildFakeLocalAddress(), emptyMap(),
                MASTER_DATA_ROLES, Version.CURRENT);
    ...
    public void testForSingleDataNode() {
        ...
        DiscoveryNode discoveryNode1 = new DiscoveryNode("", "node1", MockTcpTransport.buildFakeLocalAddress(1), emptyMap(),
                singleton(DiscoveryNode.Role.MASTER), Version.CURRENT);
        DiscoveryNode discoveryNode2 = new DiscoveryNode("", "node2", MockTcpTransport.buildFakeLocalAddress(2), emptyMap(),
        ...
        logger.info("--> adding node3");
        DiscoveryNode discoveryNode3 = new DiscoveryNode("", "node3", MockTcpTransport.buildFakeLocalAddress(3), emptyMap(),
                singleton(DiscoveryNode.Role.DATA), Version.CURRENT);
