...
public class SimpleRoutingIT extends ESIntegTestCase {
    ...
    public void testRequiredRoutingMapping_variousAPIs() throws Exception {
        ...
        assertThat(multiTermVectorsResponse.getResponses()[0].getFailure().getCause(), equalTo("routing is required for [test]/[type1]/[1]"));
        ...
        assertThat(multiTermVectorsResponse.getResponses()[1].getFailure().getCause(), equalTo("routing is required for [test]/[type1]/[2]"));
    }
