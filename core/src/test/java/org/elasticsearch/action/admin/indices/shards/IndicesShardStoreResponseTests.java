...
public class IndicesShardStoreResponseTests extends ESTestCase {
    public void testBasicSerialization() throws Exception {
        ...
        DiscoveryNode node1 = new DiscoveryNode("node1", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT);
        DiscoveryNode node2 = new DiscoveryNode("node2", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT);
