...
public class ZenDiscoveryUnitTests extends ESTestCase {
    ...
    public void testShouldIgnoreNewClusterState() {
        ...
        currentNodes.masterNodeId("a").add(new DiscoveryNode("a", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT));
        DiscoveryNodes.Builder newNodes = DiscoveryNodes.builder();
        newNodes.masterNodeId("a").add(new DiscoveryNode("a", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT));
        ...
        currentNodes.masterNodeId("b").add(new DiscoveryNode("b", MockTcpTransport.buildFakeLocalAddress(), emptyMap(), emptySet(), Version.CURRENT));
        ;
    ...
    public void testFilterNonMasterPingResponse() {
        ...
        for (int i = randomIntBetween(10, 20); i >= 0; i--) {
            ...
            DiscoveryNode node = new DiscoveryNode("node_" + i, "id_" + i, MockTcpTransport.buildFakeLocalAddress(), Collections.emptyMap(),
