...
public class SearchAction extends Action<SearchRequest, SearchResponse, SearchRequestBuilder> {
    ...
    public TransportAction.ActionRunnable<SearchRequest, SearchResponse> getActionRunnable(
                    IndexNameExpressionResolver indexNameExpressionResolver, ClusterService clusterService,
                    SearchTransportService searchTransportService, SearchPhaseController searchPhaseController, SearchService searchService)
    {
        return new Runnable(indexNameExpressionResolver, clusterService, searchTransportService, searchPhaseController,
            searchService);
    }

    private static final class Runnable implements TransportAction.ActionRunnable<SearchRequest, SearchResponse>{
        ...
        private Runnable(IndexNameExpressionResolver indexNameExpressionResolver, ClusterService clusterService,
                         SearchTransportService searchTransportService, SearchPhaseController searchPhaseController,
                         SearchService searchService) {
            this.logger = Loggers.getLogger(getClass(), clusterService.getSettings());
            ...
            this.threadPool = searchTransportService.getThreadPool();
        }
        ...
        @Override
        public void execute(Task task, SearchRequest searchRequest, ActionListener<SearchResponse> listener) {
        ...
        private void executeSearch(SearchTask task, SearchTimeProvider timeProvider, SearchRequest searchRequest, String[] localIndices,
            ...
            GroupShardsIterator localShardsIterator = clusterService.operationRouting().searchShards(clusterState, concreteIndices,
        ...
        @Override
        public final void execute(SearchRequest searchRequest, ActionListener<SearchResponse> listener) {
            throw new UnsupportedOperationException("the task parameter is required");
        }

        private AbstractSearchAsyncAction searchAsyncAction(SearchTask task, SearchRequest searchRequest,
                                                            GroupShardsIterator shardIterators, SearchTimeProvider timeProvider,
