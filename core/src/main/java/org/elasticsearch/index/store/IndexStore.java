...
public class IndexStore extends AbstractIndexComponent {
    ...
    public IndexStore(IndexSettings indexSettings, IndexStoreConfig indexStoreConfig) {
        ...
        rateLimiting.setType(indexSettings.get(INDEX_STORE_THROTTLE_TYPE_SETTING));
        rateLimiting.setMaxRate(indexSettings.get(INDEX_STORE_THROTTLE_MAX_BYTES_PER_SEC_SETTING));
        indexSettings.addSettingsUpdateConsumer(INDEX_STORE_THROTTLE_MAX_BYTES_PER_SEC_SETTING, rateLimiting::setMaxRate);
