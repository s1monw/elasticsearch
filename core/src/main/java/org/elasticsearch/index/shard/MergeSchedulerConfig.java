...
public final class MergeSchedulerConfig {
    ...
    public MergeSchedulerConfig(IndexSettings indexSettings) {
        maxThreadCount = indexSettings.get(MAX_THREAD_COUNT_SETTING);
        maxMergeCount = indexSettings.get(MAX_MERGE_COUNT_SETTING);
        this.autoThrottle = indexSettings.get(AUTO_THROTTLE_SETTING);
